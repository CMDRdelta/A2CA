...
(function(){
  ...
  function updateTransportStatus(){
    ...
    if($('fetchQueryBtn'))$('fetchQueryBtn').disabled=false;
  }
  ...
  async function fetchText(url,options,timeoutMs=90000){
    try{
      ...
      if(e instanceof TypeError||/Failed to fetch|NetworkError|Load failed/i.test(String(e&&e.message))){
        throw new Error('The A2CA server could not contact NCBI. Please retry later or check the service status.');
      }
      throw e;
    }
  }
